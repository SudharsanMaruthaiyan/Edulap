...
const InstructorCard = (props) => {
  return (
    <>
        <div className="  shadow-xl p-2 pb-3 rounded-2xl border-[2px] relative overflow-hidden mt-10 md:mt-16">
           <div className=" inline-block overflow-hidden">
                <img className="hover:scale-125 transition-transform duration-500 object-cover" src={props.team1} alt="" />
           </div>
            <div className=" flex flex-col justify-center bg-[#525FE1] absolute top-[221px] md:top-[174px] lg:top-[44.2px] xl:top-[97px] " id="link">
